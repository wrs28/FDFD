"""
channels = ChannelStruct(tqn, wg, side)
"""
...
"""
inputs = Inputs(coord, N, N_ext, ℓ, ℓ_ext, x̄, x̄_ext, x̄_inds, dx̄, x₁, x₁_ext,
    x₁_inds, x₂, x₂_ext, x₂_inds, ∂R, ∂R_ext, ∂S, r, r_ext, n₁_vals, n₁_inds,
    n₂_vals, n₂_inds, ɛ, ɛ_ext, ɛ_sm, F_vals, F_inds, F, F_ext, F_sm, ω₀, k₀,
    γ⟂, D₀, a, bc, bc_sig, bk, input_modes, scatteringRegions, channels,
...
∇ =  grad1d(N, dx)
    ...
    sparse ∇[N,N+1]
"""
function grad1d(N::Int, dx::Float64)::SparseMatrixCSC{Complex128,Int}
...
function processInputs(
    ...
    ɛ_sm, F_sm, r_ext = subPixelSmoothing( (x₁, x₂), (x₁_ext, x₂_ext),
